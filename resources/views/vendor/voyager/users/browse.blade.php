...
@section('content')
    <div class="page-content browse container-fluid">
        ...
        <div class="row">
            <form action="{{asset('admin/users')}}" style="border: #97999C solid 1px; padding: 0.8%" class="col-md-12">
                <div class="col-md-2">
                    <label for="status">Status</label>
                    <select name="status" id="status">
                        <option value="{{$request->get('status')}}">{{$request->get('status')}}</option>
                        @foreach(\App\Models\User::STATUS_NAMES as $statusId => $statusName)
                ...
                <div class="col-md-3">
                    ...
                    <input type="datetime-local" name="from" value="{{$request->get('from')}}">
                </div>
                <div class="col-md-3">
                    <p style="display: inline-block">to</p>
                    <input type="datetime-local" name="to" value="{{$request->get('to')}}">
                </div>
                <div class="col-md-2">
